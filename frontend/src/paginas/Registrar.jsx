...
const Registrar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password.length < 6) {
      setAlerta({
        msg: "Password no cumple requisitos, agrega minimo 8 caracteres",
        error: true,
      });
      return;
    }
    ...
    <>
      <div>
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center">
          <div
            className="absolute top-0 left-0 flex flex-wrap gap-2 sm:gap-4 ml-4 mt-4"style={{ backgroundColor: "#053861" }} >
